    ...
    <div className="p-8 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-4 space-y-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <select
            ...
            onChange={(e) => setFilters({ ...filters, status: e.target.value as '' | 'active' | 'inactive' | 'discontinued' })}
            className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          >
      ...
      <ProductModal
        ...
        product={selectedProduct ? {
          ...
          palletQuantity: selectedProduct.palletQuantity,
          caseDimensions: selectedProduct.caseDimensions,
          palletDimensions: selectedProduct.palletDimensions,
          weight: selectedProduct.weight,
          weightUnit: selectedProduct.weightUnit,
          palletWeight: selectedProduct.palletWeight,
          palletWeightUnit: selectedProduct.palletWeightUnit,
